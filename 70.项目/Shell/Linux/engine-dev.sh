APP_HOME=/data/service/webapps/engine-dev
RUN_PATH=/data/service/run
APP_NAME=main
LOG_PATH=/data/service/logs/engine-dev
LOG_FILE=$LOG_PATH/$APP_NAME-dev.log
PID_FILE=$RUN_PATH/$APP_NAME-dev.pid

APP_OPTS=" -port=9017 -segmenterDictionary=/data/service/webapps/engine-dev/data/dictionary.txt -stopTokenFile=/data/service/webapps/engine-dev/data/stop_tokens.txt -storageFolder=/data/service/webapps/engine-dev/index"
for arg in "$@"
do
