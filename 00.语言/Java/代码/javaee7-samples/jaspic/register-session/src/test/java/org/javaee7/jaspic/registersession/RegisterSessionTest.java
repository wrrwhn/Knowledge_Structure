...
public class RegisterSessionTest extends ArquillianBase {
    ...
    public void testRemembersSession() throws IOException, SAXException {
        ...
        // Both the com.com.yao.business.user name and roles/groups have to be restored
    ...
    public void testJoinSessionIsOptional() throws IOException, SAXException {
        ...
        // session we shouldn't see the com.com.yao.business.user's name and roles.
        ...
        assertFalse(response.contains("web com.com.yao.business.user has role \"architect\": true"));
    }
}