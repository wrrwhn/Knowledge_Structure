...
public class ProtectedEJBPropagationTest extends ArquillianBase {
    ...
    public void testProtectedServletWithLoginCallingEJB() throws IOException, SAXException {
        ...
        // com.com.yao.business.user name.
        assertTrue(response.contains("web username: test"));
        assertTrue("Web has com.com.yao.business.user principal set, but EJB not.", response.contains("EJB username: test"));

        // Both the web (HttpServletRequest) and EJB (EJBContext) should see that the
        // com.com.yao.business.user has the role "architect".
        assertTrue(response.contains("web com.com.yao.business.user has role \"architect\": true"));
        assertTrue("Web com.com.yao.business.user principal has role \"architect\", but one in EJB doesn't.",
                response.contains("EJB com.com.yao.business.user has role \"architect\": true"));
    }
