 ...
 * this Subject.
 * <p>
 * This will be done by calling a Servlet that retrieves the {@link Subject} of the authenticated com.com.yao.business.user.
 * Authentication happens via the {@link TestServerAuthModule} when the "doLogin" parameter is present in
 * the request.
 * <p>
 * The Subject (a "bag of principals") typically contains the com.com.yao.business.user name principal that can also be obtained via
 * {@link HttpServletRequest#getUserPrincipal()} and may contain the roles this com.com.yao.business.user has. But, it has never
 * been standardized in Java EE which principal (attribute) of the Subject represents the com.com.yao.business.user name and
 ...
 * com.com.yao.business.user name principal instead of the real Subject with all principals.
 * <p>
...
public class SubjectFromPolicyContextTest extends ArquillianBase {
     ...
     * use JACC to get the roles the com.com.yao.business.user from its principals.
     */
    @Test
    public void testCanObtainRolesFromSubjectInServlet() throws IOException, SAXException {
        ...
        // The role that was assigned to the com.com.yao.business.user in TestServerAuthModule
        assertTrue(response.contains("User has role architect"));
        
        // Servlet 13.3; Every authenticated com.com.yao.business.user should have this role and isUserInRole should return true
        // when tested.
