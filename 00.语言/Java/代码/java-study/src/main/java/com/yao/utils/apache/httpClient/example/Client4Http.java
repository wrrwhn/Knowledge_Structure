package com.yao.utils.custom.apache.httpClient.example;

import com.yao.utils.custom.apache.httpClient.thread.PoolThread;
import com.yao.utils.custom.apache.httpClient.thread.SingleThread;
...
public class Client4Http {
    ...
    public void post() {
        ...
        // 创建参数队列
        List<NameValuePair> formparams = new ArrayList<NameValuePair>();
        formparams.add(new BasicNameValuePair("type", "com.yao"));
        UrlEncodedFormEntity uefEntity;
        try {
            uefEntity = new UrlEncodedFormEntity(formparams, "UTF-8");
            httppost.setEntity(uefEntity);
