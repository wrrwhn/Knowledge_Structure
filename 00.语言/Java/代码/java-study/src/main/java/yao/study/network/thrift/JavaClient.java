...
import yao.study.network.thrift.shared.SharedStruct;
import yao.study.network.thrift.tutorial.Calculator;
import yao.study.network.thrift.tutorial.InvalidOperation;
import yao.study.network.thrift.tutorial.Operation;
import yao.study.network.thrift.tutorial.Work;
